...
<div class="row justify-content-center">
  <div class="col-xl-12 ">
    <div class="card mb-4">
      <div class="card-body">
        <form action="{{ route('project.update', ['encodedId' => Crypt::encrypt($project->id)]) }}" method="POST"
          ...
          <div class="row">
            <div class="col-md-4 mb-3">
              ...
              <select class="form-select" name="created_by" id="created_by" disabled>
                ...
                <option value="{{ $creator->id }}" {{ $project->created_by == $creator->id ? 'selected' : '' }}>
                  {{ $creator->name }}
                </option>
                @endforeach
              </select>
          ...
          <div class="row">
            <div class="col-lg-12  mb-3">
              ...
              <textarea type="text" class="form-control" name="description" id="editor"
                placeholder="Enter Project Description..." rows="4" cols="50"
