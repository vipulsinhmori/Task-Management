                ...
                <div class="card-body">
                    <form action="{{ route('task.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select " id="assigned-to-select" name="assigned_to">
                                    <option selected disabled>-- Assigned select --</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <label class="form-label" for="date">Start Date <span
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center mt-3">
                                <button href="{{ route('sendEmail.index') }}" type="submit"
                                    class="btn btn-sm btn-primary me-3">Save</button>
