...
<div class="row justify-content-center">
    <div class="col-xl-12">
        <div class="card mb-4">
            <div class="card-body">
                <form action="{{ route('task.update', ['encodedId' => Crypt::encrypt($task->id)]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select" name="created_by" disabled>
                                ...
                                <option value="{{ $creator->id }}" {{ $task->created_by == $creator->id ? 'selected' : '' }}>
                                    {{ $creator->name }}
                                </option>
                                @endforeach
                            </select>
