...
@foreach ($taskes as $task)
<div class="modal fade" id="viewModal{{ $task->id }}" tabindex="-1" aria-labelledby="modalLabel{{ $task->id }}"
    aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="modalLabel{{ $task->id }}">Task View - {{ $task->title }}</h1>
            </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        ...
                        <p class="text-muted">
                            @switch($task->status)
                            @case(1)
                            <span class="badge rounded-pill text-bg-secondary">Padding</span>
                            @break

                            @case(2)
                            <span class="badge rounded-pill text-bg-primary"> Progress</span>
                            @break
