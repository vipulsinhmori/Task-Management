                    ...
                    <form action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mt-1" id="image-preview-container" style="display:none;">
                                ...
                                <img class="img-circle img-thumbnail shadow" id="image-preview" src="#"
                                    alt="Image Preview" width="70" height="70" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4 mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select id="country" class="select2 form-select" name="country">
                                    ...
                                    <option value="web-devlopment">India</option>
